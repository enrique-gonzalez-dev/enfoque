...
Rails.application.configure do
  ...
  config.assets.js_compressor = SelectiveAssetsCompressor.new(:harmony => true)
  ...
  # config.active_job.queue_name_prefix = "tomahawk_#{Rails.env}"
  ...
  config.action_mailer.smtp_settings = {
    ...
    user_name: ENV['MAIL_PRODUCTION'],
    password: ENV['MAIL_PASSWORD_PRODUCTION']
  }
